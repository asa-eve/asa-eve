...
## 🛠 Projects:
- [**NY Taxi Trip Duration prediction (regression)**]([New-York-City-Taxi-Trip-Duration](https://github.com/asa-eve/New-York-City-Taxi-Trip-Duration)) [Pandas, Scikit-Learn, Seaborn, SQL, Docker]
- [**Competitive Data Science methods**](https://github.com/asa-eve/DS-code-practice) [TBD]
- [**Automated LLM code parser for ML development on Kaggle**](https://github.com/asa-eve/Kaggle-Competition-Code-Parser) [ML, LLMs, AzureVMS]
- [**Microgrid battery management using Deep Reinforcement Learning**](https://github.com/asa-eve/Battery_Energy_Management_RL) [MILP, ML, RL]
- [**Stock Trading Bot**](https://github.com/asa-eve/Trading_Bot_RL) [ML, RL]
